...
dict_continent=dict()
dict_continent['asia']=['hong','Bangladesh','laos','cote ivoire'
,'mongol peo rep'                        
,'Bhutan'
,'Brunei Darussalam'
,'Cambodia'
...
dict_continent['south america']=['south','Argentina','cuba','trinid & tobago'
,'Bolivia'
,'Brazil'
,'Chile'
,'Colombia'
...
dict_continent['europe']=['rep','russia','serbia','syria','scotland','Albania','north ireland','moldova','serbia monteneg','montenegro'
,'Andorra'
,'Anguilla'
,'Antarctica'
,'Antigua and Barbuda'
...
,'Belarus'
,'Belgium'
,'Bosnia and Herzegovina','bosnia & herceg'
,'Bouvet Island'
...
dict_continent['middle east']=['iran','Bahrain','iraq'
,'Egypt'
,'Israel'
,'Jordan'
,'Kuwait'
...
dict_continent['africa']=['Algeria','malagasy republ','tanzania'
,'Angola'
,'Benin'
,'Botswana'
,'Burkina Faso'
